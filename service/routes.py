...
def list_accounts():
    ...
    accountList = [account.serialize() for account in accountsDeserialized]
    app.logger.info("Returning [%s] accounts", len(accountList))
...
def update_account(id):
    ...
    """
    app.logger.info("Updating account id: %s", id)
